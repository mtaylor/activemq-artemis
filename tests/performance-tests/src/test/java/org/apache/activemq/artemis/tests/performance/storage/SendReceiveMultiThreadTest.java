...
public class SendReceiveMultiThreadTest extends ActiveMQTestBase {
   ...
   final String DIRECTORY = "/home/mtaylor/testing/perf/journal";
   ...
   public void testMultipleWrites() throws Exception {
      ...
      server.getConfiguration().setJournalMaxIO_AIO(1500);

      AddressSettings addressSettings = new AddressSettings();
      addressSettings.setAddressFullMessagePolicy(AddressFullMessagePolicy.BLOCK);
      addressSettings.setMaxSizeBytes(100 * 1024 * 1024);

      Map<String, AddressSettings> addressSettingsMap = new HashMap<String, AddressSettings>();
      addressSettingsMap.put("#", addressSettings);

      server.getConfiguration().setAddressesSettings(addressSettingsMap);
      ...
      cf.setProducerWindowSize(10 * 1024 * 1024);
      ...
      //System.out.println("Number of compacting executed::" + JournalImpl.compactCount);
   }
      ...
      public void run() {
         try {
            ...
            for (int i = 0; i < numberOfMessages; i++) {
               ...
               if (r % 1000 == 0) {
                  System.out.println("Client Received " + message.getLongProperty("seq") + " messages");
               }
      ...
      public void run() {
         try {
            ...
            for (int i = 0; i < numberOfMessages; i++) {
               ...
               Long seql = seq.getAndIncrement();
               msg.setLongProperty("seq", seql);
