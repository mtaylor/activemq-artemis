   ...
   @BMRules(
      rules = {
         @BMRule(
            ...
            condition = "!flagged(\"shuttingDown\")",
         ...
         @BMRule(
            ...
            targetMethod = "stop",
            targetLocation = "ENTRY",
            action = "flag(\"shuttingDown\"); org.apache.activemq.artemis.tests.extras.byteman.critical.analyzer.DeadlockStorageManagerTest.releaseStorageManagerLock()" )
      })
   @Test(timeout = 60000)
