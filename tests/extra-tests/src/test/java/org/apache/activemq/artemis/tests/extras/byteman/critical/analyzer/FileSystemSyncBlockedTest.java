   ...
   @BMRules(
      rules = {
         @BMRule(
            ...
            condition = "!flagged(\"shuttingDown\")",  // Once the server shutdowns we stop applying this rule.
            action = "waitFor(\"SuspendedThread\")"),
         @BMRule(
            ...
            targetMethod = "stop",
            targetLocation = "ENTRY",
            action = "flag(\"shuttingDown\"); signalWake(\"SuspendedThread\")")
      })
   @Test(timeout = 60000)
