...
public class JournalStorageManager extends AbstractJournalStorageManager {
   ...
   private int perfBlastPages;

   private String largeMessagesDirectory;

   private FileJournalReplicationHandler replicationHandler;
   ...
   public void startReplication(ReplicationManager replicationManager,
      ...
      replicationHandler.startReplication(replicationManager, pagingManager, nodeID, autoFailBack, initialReplicationSyncTimeout);
   }
   ...
   /**
    * Utility class to encapsulate replication behaviour for the File Journal Implementation
    *
    * <p>
   ...
   private class FileJournalReplicationHandler {
      ...
      private void largeMessageWrite(long messageId, byte[] bytes) {
         if (isReplicated()) {
            replicator.largeMessageWrite(messageId, bytes);
         }
      }

      private void largeMessageBegin(long id) {
         if (isReplicated()) {
      ...
      private boolean isSynchronizing() {
         return replicator.isSynchronizing();
      }
   }
}