...
public class GenericSQLProvider implements SQLProvider {
   ...
   public GenericSQLProvider(String tableName) {
      ...
      selectFileNamesByExtensionSQL = "SELECT FILENAME FROM " + tableName + " WHERE EXTENSION=?";
      ...
      copyFileRecordByIdSQL = "INSERT INTO " + tableName + "(FILENAME, EXTENSION, DATA) " +
   ...
   @Override
   public String getSelectFileById() {
