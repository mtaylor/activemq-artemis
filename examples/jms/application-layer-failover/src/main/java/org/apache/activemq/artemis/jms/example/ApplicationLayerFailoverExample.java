...
public class ApplicationLayerFailoverExample
{
   ...
   public static void main(final String[] args)
   {
      try
      {
         server0 = ExampleUtil.startServer(args[0], ApplicationLayerFailoverExample.class.getSimpleName() + "0", 0, 5000);
         server1 = ExampleUtil.startServer(args[1], ApplicationLayerFailoverExample.class.getSimpleName() + "1", 1, 5000);
         ...
         ExampleUtil.killServer(server0);
