...
public class ClientSideFailoverListerExample
{
   ...
   public static void main(final String[] args) throws Exception
   {
      ...
      try
      {
         server0 = ExampleUtil.startServer(args[0], ClientSideFailoverListerExample.class.getSimpleName() + "0", 0, 5000);
         server1 = ExampleUtil.startServer(args[1], ClientSideFailoverListerExample.class.getSimpleName() + "1", 1, 0);
