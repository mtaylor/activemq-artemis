...
import org.apache.activemq.artemis.common.example.ExampleUtil;
...
public class ClusterStaticOnewayExample
{
   public static void main(final String[] args) throws Exception
   {
      ...
      try
      {
         ...
         int con0Node = ExampleUtil.getServer(connection0);
         int con1Node = ExampleUtil.getServer(connection1);
         int con2Node = ExampleUtil.getServer(connection2);
         ...
         Session sendSession = ExampleUtil.getServerConnection(0, connection0, connection1, connection2).createSession(false, Session.AUTO_ACKNOWLEDGE);
